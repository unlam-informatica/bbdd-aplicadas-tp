...
VALUES (@ParqueIdPrueba, 'Tour Sendero Norte', 'Tours guiados', 120, 20, 15000.00);
SET @ActividadId1 = SCOPE_IDENTITY();

INSERT INTO Parques.Actividad (ParqueId, Nombre, Tipo, DuracionMinutos, CupoMaximo, Valor)
VALUES (@ParqueIdPrueba, 'Tour Mirador Sur', 'Tours guiados', 90, 25, 12000.00);
SET @ActividadId2 = SCOPE_IDENTITY();

INSERT INTO Parques.Actividad (ParqueId, Nombre, Tipo, DuracionMinutos, CupoMaximo, Valor)
VALUES (@ParqueIdPrueba, 'Tour Laguna Azul', 'Tours guiados', 60, 15, 9000.00);
SET @ActividadId3 = SCOPE_IDENTITY();

INSERT INTO Parques.Actividad (ParqueId, Nombre, Tipo, DuracionMinutos, CupoMaximo, Valor)
VALUES (@ParqueIdAux, 'Tour Parque Auxiliar', 'Tours guiados', 60, 10, 7000.00);
